...
async def update_role_relationship(role_relationship_id: int, role_relationship: RoleRelationshipUpdate, from_party_role_id: str) -> Optional[RoleRelationshipOut]:
    async with database.transaction():
        try:
            ...
            if role_relationship.to_party_role_id is not None:
                query_parts.append("to_party_role_id = :to_party_role_id")
                values["to_party_role_id"] = role_relationship.to_party_role_id
            ...
            history_values = {
                ...
                "to_party_role_id": values.get("to_party_role_id", current_role_relationship.to_party_role_id),
