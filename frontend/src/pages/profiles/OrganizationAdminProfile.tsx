...
const OrganizationAdminProfile: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      if (!isAuthenticated || role !== 'organization_admin') {
        setError('Please log in as Organization Admin');
        setLoading(false);
        logout();
  ...
  // ฟังก์ชันสำหรับกลับไปยังหน้า dashboard ของ Organization Admin
  const handleBackToHome = () => {
    navigate('/homes/organization_admin');
  };
          ...
          <InfoBox>
            <List>
              ...
              <ListItem>
                ...
                <ListItemText
                  primary="Role"
                  secondary={user.role || 'Organization Admin'}
                  primaryTypographyProps={{ fontWeight: 'bold' }}
                />
              </ListItem>
              <Divider component="li" />
