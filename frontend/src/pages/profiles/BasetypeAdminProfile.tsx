...
const BasetypeAdminProfile: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      if (!isAuthenticated || role !== 'basetype_admin') {
        setError('Please log in as Basetype Admin');
        setLoading(false);
        logout();
  ...
  // ฟังก์ชันสำหรับกลับไปยังหน้า dashboard ของ Basetype Admin
  const handleBackToHome = () => {
    navigate('/homes/basetype_admin');
  };
          ...
          <InfoBox>
            <List>
              ...
              <ListItem>
                ...
                <ListItemText
                  primary="Role"
                  secondary={user.role || 'Basetype Admin'}
                  primaryTypographyProps={{ fontWeight: 'bold' }}
                />
              </ListItem>
              <Divider component="li" />
...
export default BasetypeAdminProfile;