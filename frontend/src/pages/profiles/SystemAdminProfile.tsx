...
const SystemAdminProfile: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      if (!isAuthenticated || role !== 'system_admin') {
        setError('Please log in as System Admin');
        setLoading(false);
        logout();
  ...
  // ฟังก์ชันสำหรับกลับไปยังหน้า dashboard ของ System Admin
  const handleBackToHome = () => {
    navigate('/homes/system_admin');
  };
          ...
          <InfoBox>
            <List>
              ...
              <ListItem>
                ...
                <ListItemText
                  primary="Role"
                  secondary={user.role || 'System Admin'}
                  primaryTypographyProps={{ fontWeight: 'bold' }}
                />
              </ListItem>
              <Divider component="li" />
