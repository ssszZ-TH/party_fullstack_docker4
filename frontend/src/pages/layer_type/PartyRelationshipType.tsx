...
import { create, get, list, update, deleteById } from "../../services/partyrelationshiptype";
import UpdateButton from "../../components/buttons/UpdateButton";
import DeleteButton from "../../components/buttons/DeleteButton";
import AddButton from "../../components/buttons/AddButton";

export default function PartyRelationshipType() {
  ...
  return (
    <>
      <AppBarCustom title="Party Relationship Type ประเภทความสัมพันธ์" />
      {loading ? (
        <Loading />
      ) : (
        <DataTable
