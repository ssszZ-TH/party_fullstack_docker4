...
import { create, get, list, update, deleteById } from "../../services/prioritytype";
import UpdateButton from "../../components/buttons/UpdateButton";
import DeleteButton from "../../components/buttons/DeleteButton";
import AddButton from "../../components/buttons/AddButton";

export default function PriorityType() {
  ...
  return (
    <>
      <AppBarCustom title="Priority Type ประเภทความสำคัญ" />
      {loading ? (
        <Loading />
      ) : (
        <DataTable
