...
import { create, get, list, update, deleteById } from "../../services/contactmechanismtype";
import UpdateButton from "../../components/buttons/UpdateButton";
import DeleteButton from "../../components/buttons/DeleteButton";
import AddButton from "../../components/buttons/AddButton";

export default function ContactMechanismType() {
  ...
  return (
    <>
      <AppBarCustom title="Contact Mechanism Type ประเภทช่องทางการติดต่อ" />
      {loading ? (
        <Loading />
      ) : (
        <DataTable
