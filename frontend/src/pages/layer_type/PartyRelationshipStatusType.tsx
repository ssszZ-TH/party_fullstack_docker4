...
import { create, get, list, update, deleteById } from "../../services/partyrelationshipstatustype";
import UpdateButton from "../../components/buttons/UpdateButton";
import DeleteButton from "../../components/buttons/DeleteButton";
import AddButton from "../../components/buttons/AddButton";

export default function PartyRelationshipStatusType() {
  ...
  return (
    <>
      <AppBarCustom title="Party Relationship Status Type ประเภทสถานะความสัมพันธ์" />
      {loading ? (
        <Loading />
      ) : (
        <DataTable
