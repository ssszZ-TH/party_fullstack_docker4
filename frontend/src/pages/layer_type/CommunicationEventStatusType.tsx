...
import { create, get, list, update, deleteById } from "../../services/communicationeventstatustype";
import UpdateButton from "../../components/buttons/UpdateButton";
import DeleteButton from "../../components/buttons/DeleteButton";
import AddButton from "../../components/buttons/AddButton";

export default function CommunicationEventStatusType() {
  ...
  return (
    <>
      <AppBarCustom title="Communication Event Status Type ประเภทสถานะการสื่อสาร" />
      {loading ? (
        <Loading />
      ) : (
        <DataTable
